...
def run_migrations_online() -> None:
    ...
    # We can either use engine_from_config or just create an engine from DATABASE_URL
    # For simplicity and consistency with our app, let's just use DATABASE_URL
