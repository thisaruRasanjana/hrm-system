  ...
  return (
    <header className="flex items-center justify-between px-8 py-4 bg-white border-b border-gray-200 shrink-0">
      ...
      <div className="flex items-center gap-5 text-gray-400">
        <button className="relative hover:text-gray-600 transition-colors" aria-label="Notifications">
          <IconBell />
          <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-orange-400 rounded-full border-2 border-white"></span>
        </button>
